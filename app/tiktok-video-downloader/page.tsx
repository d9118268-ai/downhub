...
export const metadata: Metadata = {
  ...
  description:
    "Use DownHub's TikTok video downloader for supported content you own or have permission to download.",
  keywords: [
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 pb-16 pt-24 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-400">
          Use DownHub to access supported TikTok video downloading features
          online. Paste a supported TikTok URL to get started.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        <h2 className="text-3xl font-bold">How to use the TikTok downloader</h2>

        <div className="mt-8 grid gap-5 sm:grid-cols-3">
          {[
            ["01", "Copy the URL", "Copy the URL of a supported TikTok video."],
      ...
      <section className="border-t border-white/10 bg-slate-900/50">
        <div className="mx-auto max-w-4xl px-6 py-20">
          <h2 className="text-3xl font-bold">TikTok Downloader FAQ</h2>
          ...
          <div className="mt-8 space-y-4">
            <details className="rounded-xl border border-white/10 bg-slate-950 p-5">
              ...
              <p className="mt-3 text-slate-400">
                ...
                functionality for supported TikTok content.
              </p>
            </details>
