...
export const metadata: Metadata = {
  title: "FB Video Downloader Online",
  description:
    "Use DownHub's Facebook video downloader for supported content you own or have permission to download.",
  keywords: [
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 pb-16 pt-24 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-400">
          Use DownHub to access supported Facebook video downloading features
          online. Paste a supported Facebook URL to get started.
        </p>
      ...
      <section className="border-y border-white/10 bg-slate-900/50">
        <div className="mx-auto max-w-4xl px-6 py-20">
          ...
          <div className="mt-6 space-y-5 leading-8 text-slate-400">
            <p>
              DownHub provides a simple interface for supported Facebook download
              downloading. The service is designed to work across desktop and
              mobile browsers.
            </p>
            <p>
              Copy a supported Facebook video URL, paste it into the downloader,
              and use the available options when the content is authorized for
              downloading.
            </p>
            <p>
              Always respect the rights of the content creator and the
              applicable Facebook terms before downloading content.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        <h2 className="text-3xl font-bold">How to use the Facebook downloader</h2>

        <div className="mt-8 grid gap-5 sm:grid-cols-3">
          {[
            ["01", "Copy the URL", "Copy the URL of a supported Facebook video."],
      ...
      <section className="border-t border-white/10 bg-slate-900/50">
        <div className="mx-auto max-w-4xl px-6 py-20">
          <h2 className="text-3xl font-bold">Facebook Downloader FAQ</h2>
          ...
          <div className="mt-8 space-y-4">
            <details className="rounded-xl border border-white/10 bg-slate-950 p-5">
              ...
              <p className="mt-3 text-slate-400">
                ...
                functionality for supported Facebook content.
              </p>
            </details>
